...
<body>
    ...
    <div class="breadcumb-area bg-img" style="background-image: url(/indexcss/img/bg-img/awal-1.jpeg);">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="about-content">
                        <h2>About Duta Bina Bhuana Foundation</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto">
                        <h3>Founders Of Duta Bina Bhuanan Foundation</h3>
                    </div>
                </div>
            </div>
