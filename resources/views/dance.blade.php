...
<head>
    ...
    <!-- Title -->
    <title>Balinese Dance Class</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md-6">
                    <div class="breadcumb-text">
                        ...
                        <h2>Bali OSEC Balinese Dance Class</h2>
    ...
    <section class="ministries-area section-padding-100-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div>
                        <h3>Balinese Dance Class</h3>
                        <p>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                        <h3>Balinese Dance Class Program</h3>
                        <ol>
                            <ul type="disc">
                                <li>- xxxxxxx</li>
                                <li>- xxxxxxx</li>
